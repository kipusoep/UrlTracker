...
## Umbraco 7.3.5 and lower ##
**Umbraco 7.3.5 and lower** has known issues with the Url Tracker. These are resolved in Umbraco 7.3.6 and 7.4, so please don't use 7.3.5 or lower in combination with the Url Tracker.

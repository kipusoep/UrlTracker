<%@ Control Language="C#" AutoEventWireup="True" CodeBehind="CreateView.ascx.cs" Inherits="InfoCaster.Umbraco.UrlTracker.UI.UserControls.CreateView" %>
...
<fieldset>
    ...
    <asp:Panel runat="server" ID="pnlRootNode" CssClass="control-group">
        ...
        <div class="controls">
            <asp:DropDownList runat="server" ID="ddlRootNode" AppendDataBoundItems="true" DataTextField="Text" DataValueField="Value" CssClass="input-xlarge"><asp:ListItem Value="-1">/</asp:ListItem></asp:DropDownList>
        </div>
    </asp:Panel>
    <div class="clearfix">
        ...
        <div class="control-group group">
            <label class="control-label" for="<%= tbOldRegex.ClientID %>"><%= UrlTrackerResources.Regex %> <a href="http://gskinner.com/RegExr/" target="_blank" data-toggle="tooltip" title="<%= UrlTrackerResources.RegexInfo %>"><i class="icon-question-sign"></i></a></label>
            <div class="controls">
